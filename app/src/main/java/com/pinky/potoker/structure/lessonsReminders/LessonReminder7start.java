...
public class LessonReminder7start extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Седьмой урок начался";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 13);
    }
}
