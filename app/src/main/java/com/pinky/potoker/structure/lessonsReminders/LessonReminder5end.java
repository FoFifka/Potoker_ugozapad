...
public class LessonReminder5end extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Пятый урок закончился";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 10);
    }
}
