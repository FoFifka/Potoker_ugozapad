...
public class LessonReminder6start extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Шестой урок начался";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 11);
    }
}
