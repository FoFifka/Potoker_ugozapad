...
public class LessonReminder2start extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Второй урок начался";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 3);
    }
}
