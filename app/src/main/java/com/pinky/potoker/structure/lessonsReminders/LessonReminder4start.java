...
public class LessonReminder4start extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Четвёртый урок начался";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 7);
    }
}
