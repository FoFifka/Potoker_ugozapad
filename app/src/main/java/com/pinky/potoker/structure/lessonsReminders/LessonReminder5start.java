...
public class LessonReminder5start extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Пятый урок начался";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 9);
    }
}
