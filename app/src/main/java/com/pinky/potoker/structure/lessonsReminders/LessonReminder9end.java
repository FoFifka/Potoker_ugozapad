...
public class LessonReminder9end extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Девятый урок закончился(Если он у вас есть)";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 18);
    }
}
