...
public class LessonReminder7end extends BroadcastReceiver {
    String title = "УРОК";
    String text = "Седьмой урок закончился";

    LessonNotification ln = new LessonNotification();
    @Override
    public void onReceive(Context context, Intent intent) {
        ln.startNotification(context, title , text , Params.CHANNEL_1_ID, 14);
    }
}
